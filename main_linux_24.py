...
if __name__ == "__main__":
    file_names = ["24-可见光通信与光计算 - 可见光通信与光计算系统", "24-可见光通信与光计算 - 可见光通信与光计算系统试验", "24-可见光通信与光计算 - 可见光通信与光计算系统注册与受理库", "24-可见光通信与光计算 - 正交频分复用（OFDM）调制技术", "24-可见光通信与光计算 - 中国上市可见光通信与光计算系统"]
